...
class SetupController extends Controller
{
    public function actionHomepage()
    {
        ...
        try {
            ...
            if ($fieldsService->saveField($siteTitle)) {
            ...
            if ($fieldsService->saveField($siteDescription)) {
            ...
            if ($fieldsService->saveField($siteLocation)) {
            ...
            $fieldLayoutData = [
                'tabs' => [
                    [
                        ...
                        'fields' => [
                            [
                                'fieldId' => $siteTitle->id,
                                'required' => false
                            ],
                            [
                                'fieldId' => $siteDescription->id,
                                'required' => false
                            ],
                            [
                                'fieldId' => $siteLocation->id,
                                'required' => false
                            ]
                        ]
                    ]
            ...
            $fieldLayout = Craft::$app->getFields()->createLayout($fieldLayoutData);
            ...
            if (Craft::$app->getElements()->saveElement($entry)) {
                ...
                echo "✗ Failed to create homepage content entry: " . implode(', ', $entry->getFirstErrors()) . "\n";
            }
